  ...
  return (
    <div className="relative min-h-screen bg-gray-50">
      ...
      <main className="mt-10 mb-20">
        <div className="w-[90%] max-w-[700px] mx-auto bg-white shadow-md rounded-lg p-6">
          {/* Logo */}
          ...
          <form className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:gap-6">
              ...
              <div className="flex-1 mt-4 sm:mt-0">
                <label className="block text-gray-700 mb-2 text-sm font-medium">Post Code*</label>
                <input
                  type="text"
            ...
            <div className="flex flex-col sm:flex-row sm:gap-6">
              ...
              <div className="flex-1 mt-4 sm:mt-0">
                <label className="block text-gray-700 mb-2 text-sm font-medium">Region/State*</label>
                <input
                  type="text"
